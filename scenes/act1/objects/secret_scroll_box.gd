## Ported from Lango-Zelda-RPG World/Chest.gd — state enum pattern
class_name SecretScrollBox
...
enum BoxState { INTACT, CRACKED, BROKEN }
...
var _state: BoxState = BoxState.INTACT
